...
var wandaufbau_wo = new THREE.CubeGeometry(2, 10, 40);
var wandaufbau_sn = new THREE.CubeGeometry(2, 10, 80);
var wandMaterial = new THREE.MeshBasicMaterial({color: 0x993366	}); //unsichtbar: 0x000000
